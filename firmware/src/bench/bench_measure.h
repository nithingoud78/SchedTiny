 ...
 *
 * @see     docs/SPEC.md REQ-MEAS-001 through REQ-MEAS-005
 * @see     docs/ARCHITECTURE.md Section 2.3 (Measurement Architecture)
 *
 * @author  @nithingoud78
 * @date    2026-07-31
 * @version 0.1.0
...
/**
 * @brief   Flush pending log entries from ring buffer to UART DMA.
 *
 * Must be called periodically from a low-priority idle task.
 * Does nothing if the UART DMA transfer is still in progress.
 */
void bench_flush_log(void);
